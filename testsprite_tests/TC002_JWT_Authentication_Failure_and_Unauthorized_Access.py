...
async def run_test():
    ...
    try:
        ...
        # -> Input invalid credentials and submit login form to verify authentication failure.
        ...
        try:
            ...
            raise AssertionError('Test case failed: Authentication did not fail as expected with invalid credentials, or protected routes did not block unauthorized access.')
