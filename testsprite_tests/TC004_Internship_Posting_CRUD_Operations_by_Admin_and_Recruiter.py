...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the Internships section to create a new internship posting.
        frame = context.pages[-1]
        # Click on Internships link in the navigation bar
        elem = frame.locator('xpath=html/body/div/div/nav/div/div/div[2]/a[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Navigate to Admin internships management page or dashboard where Admin can create internship postings.
        frame = context.pages[-1]
        # Click Dashboard link to find Admin management options
        ...
        # -> Logout and login again, ensuring to access Admin dashboard or find Admin internship management page.
        frame = context.pages[-1]
        # Click Logout button to logout from student dashboard
        ...
        try:
            ...
            raise AssertionError("Test case failed: The test plan execution has failed because the internship posting creation, update, read, or delete operations did not complete successfully as expected for Admins and Recruiters.")
