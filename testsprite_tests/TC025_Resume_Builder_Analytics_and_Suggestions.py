...
async def run_test():
    ...
    try:
        ...
        # -> Input email and password, then click Sign In to access student dashboard.
        ...
        # -> Click on Resume Builder link to access resume builder page.
        frame = context.pages[-1]
        # Click Resume Builder link to access resume builder page
        elem = frame.locator('xpath=html/body/div/div/nav/div/div/div[2]/a[5]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Click Next button to navigate to Education section and check if profile completeness analytics and suggestions appear there.
        frame = context.pages[-1]
        # Click Next to go to Education section
        elem = frame.locator('xpath=html/body/div/div/main/div/main/div/div[2]/div[3]/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Click Add Education button to add education details and check if profile completeness analytics and suggestions update.
        frame = context.pages[-1]
        ...
        # -> Fill in education details and save to check if profile completeness analytics and suggestions update.
        frame = context.pages[-1]
        ...
        await page.wait_for_timeout(3000); await elem.fill('Example University')
        ...
        frame = context.pages[-1]
        # Click Save Draft button to save education details
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Profile Completion Rate: 100%').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test failed: Resume Builder did not provide profile completeness analytics and improvement suggestions as expected in the test plan.")
